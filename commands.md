...
- checkout # a command used to switch betweenn different versions of a target entity
  - -b # a combination command that creates a new branch and immediately switches you to it
